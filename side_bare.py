...
def create_sidebar(manager,robot, enregistrement):
    ...
    lbl_rec_file = UILabel(relative_rect=pygame.Rect(10, 210, 80, 30), text="rec file :", manager=manager, container=ui_panel)
    ent_rec_file = UITextEntryLine(relative_rect=pygame.Rect(100, 210, UI_W-110, 30), manager=manager, container=ui_panel)
